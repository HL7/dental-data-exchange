...
* category[dental] = $dental-category#dental "Dental"
* category[us-core] = http://terminology.hl7.org/CodeSystem/condition-category#problem-list-item "Problem List Item"
